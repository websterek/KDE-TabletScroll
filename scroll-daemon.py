...
def emit_scroll(ui, dx_hi_res, dy_hi_res, no_horizontal):
    """Inject hi-res scroll events (120 units per notch) and a sync packet.
...
def main():
    ...
    while not _shutdown:
        ...
        if mode == SCROLL_MODE and not _shutdown:
            ...
            scroll_hi_x += nx * speed * 120
            scroll_hi_y += ny * speed * 120
